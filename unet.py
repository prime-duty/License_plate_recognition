...
def unet_train():
    ...
    concat1 = layers.concatenate([conv4, convt1], axis=-1)
    ...
    concat2 = layers.concatenate([conv3, convt2], axis=-1)
    ...
    concat3 = layers.concatenate([conv2, convt3], axis=-1)
    ...
    concat4 = layers.concatenate([conv1, convt4], axis=-1)
    ...
    print("开始训练u-net")
    model.fit(X_train, y_train, epochs=100, batch_size=5)#epochs和batch_size看个人情况调整，batch_size不要过大，否则内存容易溢出
